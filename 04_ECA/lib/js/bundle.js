...
/***/ function(module, exports, __webpack_require__) {
	...
	var ECA = __webpack_require__(1);
	var Utils = __webpack_require__(34);
	var combatHandler = void 0;
	var React = __webpack_require__(2);
	var ReactDOM = __webpack_require__(35);

	function init() {
	  ReactDOM.render(React.createElement(ECA, null), document.getElementById('main'));
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ECA = function (_React$Component) {
	  _inherits(ECA, _React$Component);

	  function ECA(props) {
	    _classCallCheck(this, ECA);

	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(ECA).call(this, props));
	  ...
	  _createClass(ECA, [{
	    key: 'getChangeRule',
	    value: function getChangeRule(idx) {
	      var _this2 = this;

	      return function () {
	        var rule = _this2.state.rule;

	        var newRule = rule;
	        newRule[idx] = rule[idx] ^ 1;
	        _this2.setState({ rule: newRule });
	      };
	    }
	    //
	    // componentDidMount() {
	    ...
	    key: 'getRuleButtons',
	    value: function getRuleButtons() {
	      var _this3 = this;

	      var rule = this.state.rule;

	      var num = 7;
	      return rule.map(function (rule, idx) {
	        var ruleHeader = '00' + (num >>> 0).toString(2);
	        ...
	        return React.createElement(
	          ...
	          React.createElement(
	            'button',
	            {
	              ...
	              onClick: _this3.getChangeRule(idx)
	            },
	            rule
	          )
	        );
	    ...
	    value: function getRows() {
	      ...
	      var maxNumberRows = _state.maxNumberRows;
	      var rule = _state.rule;

	      var rows = [];
	      var currentRowData = void 0;
	      var lastRowData = [1];
	      rows.push(React.createElement(
	        'div',
	        { key: 'rowinitial', className: 'row' },
	        React.createElement('div', { key: 'cellinitial', className: 'cell filled' })
	      ));
	      for (var i = 0; i < maxNumberRows; i++) {
	        currentRowData = [];
	        var retRow = [];
	        for (var j = 0; j < lastRowData.length + 2; j++) {
	          currentRowData[j] = this.getCellValue(j, lastRowData);
	          retRow[j] = React.createElement('div', { key: 'cell' + i + j, className: 'cell' + (currentRowData[j] ? ' filled' : '') });
	        }
	        rows.push(React.createElement(
	          'div',
	    ...
	    key: 'getCellValue',
	    value: function getCellValue(cellIndex, lastRowData) {
	      var rule = this.state.rule;

	      var parentCellValues = [];
	      ...
	      var ruleIndex = parentCellValues[2] + parentCellValues[1] * 2 + parentCellValues[0] * 4;
	      return rule[7 - ruleIndex];
	    }
	  }, {
	    key: 'render',
	    value: function render() {
	      var ruleEles = this.getRuleButtons();
	      return React.createElement(
	        'div',
	        { className: 'main' },
	        React.createElement(
